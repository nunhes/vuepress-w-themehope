...
Exemplo, estou na páxina `https://bitsolto.com/axios/` e teño estas ligazóns:

- `/test` unha vez que se fai clic lévame a`https://bitsolto.com/test`
- `test` unha vez que se fai clic lévame a`https://bitsolto.com/axios/test`
