...
- Definición de sistema distribuído.
<!-- .element: class="fragment fade-in" -->
- Avantaxes e desvantaxes dos sistemas distribuídos.
<!-- .element: class="fragment fade-in" -->
- Modelos de computación distribuída.
<!-- .element: class="fragment fade-in" -->
- Obxectivos dun sistema distribuído.
<!-- .element: class="fragment fade-in" -->
- Arquitectura software dos sistemas distribuídos.
<!-- .element: class="fragment fade-in" -->
- Sistemas operativos distribuídos vs Middleware.
<!-- .element: class="fragment fade-in" -->
- Compoñentes dun sistema distribuído.
<!-- .element: class="fragment fade-in" -->
